...
void
PortalInputCapture::cb_Activated(XdpInputCaptureSession *session, uint32_t activation_id, GVariant *options)
{
    LOG((CLOG_DEBUG "We are active! activation id=%i", activation_id));
